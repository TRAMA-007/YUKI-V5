...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["923130510486"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["923130510486"];
...
global.BotName = process.env.BOT_NAME || "Naveed";
