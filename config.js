...
// Auth information
global.pairNumber = "249112357968";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["249118738895"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["249118738895"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["249118738895"];
global.OwnerName = process.env.OWNER_NAME || "Mohammed";
global.BotName = process.env.BOT_NAME || "Eva";
