...
// Auth information
global.pairNumber = "94784198085";                         // Add your paining number with country code example "916297175943"; 
...
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["94784198085"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["916297175943"];
global.OwnerName = process.env.OWNER_NAME || "IMALKA";
global.BotName = process.env.BOT_NAME || "HANSAMAL-MD";
