...
// Auth information
global.pairNumber = "2347082526217";                         // Add your paining number with country code example "916297175943"; 
...
// Owner information
global.Owner = process.env.OWNER ? process.env.OWNER.split(",") : ["2347082526217"];
global.OwnerNumber = process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.split(",") : ["2347082526217"];
global.ownertag = process.env.OWNER_TAG ? process.env.OWNER_TAG.split(",") : ["2347082526217"];
global.OwnerName = process.env.OWNER_NAME || "Leona";
